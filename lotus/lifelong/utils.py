...
def create_experiment_dir(cfg, skill_exp_name=None, extra=""):
    prefix = "experiments"
    ...
    if skill_exp_name is not None:
        experiment_dir = (
        f"./{prefix}/{cfg.benchmark_name}/{cfg.lifelong.algo}/"
        + f"{skill_exp_name}_seed{cfg.seed}"
        )
    ...
    experiment_dir += f"/{extra}run_{experiment_id:03d}"
